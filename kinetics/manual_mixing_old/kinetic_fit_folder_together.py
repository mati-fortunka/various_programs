...
def plot_all_data(folder, smooth_method=None, window_size=5, polyorder=2, output_plot="combined_plot.png"):
    """Reads all CSV files in a folder, overlays their curves, and applies smoothing and fitting."""
    ...
    for filename in csv_files:
        ...
        if params is not None and errors is not None:
            ...
            plt.plot(time, fitted_curve, linestyle='dotted')
...
if __name__ == "__main__":
    folder_path = "/home/matifortunka/Documents/JS/data_Cambridge/MateuszF/slow_phase_test/kinetics/slits/best"
    smooth_method = 'savitzky_golay'
    window_size = 25
    polyorder = 3
    output_plot = "overlay_plot.png"
    plot_all_data(folder_path, smooth_method=smooth_method, window_size=window_size, polyorder=polyorder,
