...
This program takes pdb file and gives list of residues as a output. Apart from printing number of residue, its three letter code and chain symbol script numbers residues globally and in every chain. It also translates three letter codes to one letter adding column with them.
