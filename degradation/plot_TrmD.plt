...
# rozne tam
set title 'TrmD-ssrA degradation'
...
# dopasowanie danych
fit f(x) "dane_TrmD.csv" u 1:2 via V, Km
...
# rysowanie
plot "dane_TrmD.csv" u 1:2:3 with yerrorbars title "Data" ls 2, f(x) title "Fit" ls 1, Vmax ls 3 notitle
pause -1
