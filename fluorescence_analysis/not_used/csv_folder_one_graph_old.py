...
# Example usage
folder_path = "/home/matifortunka/Documents/JS/data_Cambridge/Tm1570/kinetcs/slow_phase_test/spectra"  # Replace with the path to your folder containing CSV files
