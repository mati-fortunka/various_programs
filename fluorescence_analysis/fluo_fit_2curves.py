...
def compare_and_plot(df1, df2, title, ylabel, save_name, base_path, config):
...
def main():
    ...
    if not conc_map1 or not conc_map2:
        print("Missing concentration files. Please check paths. Exiting.")
        return
