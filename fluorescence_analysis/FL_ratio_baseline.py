...
def extract_fluorescence_ratio_and_plot(folder_path, wavelength1, wavelength2, concentration_file, smoothing_method=None, window_size=15, spline_smoothing_factor=0.5, poly_order=3, baseline_wavelength=None):
    ...
    plt.scatter(plot_data['Urea_concentration'], plot_data['Fluorescence Ratio'], label='Data', color='b', marker='o')
    if popt is not None:
...
extract_fluorescence_ratio_and_plot(folder_path, wavelength1, wavelength2, concentration_file, smoothing_method, window_size, spline_smoothing_factor, poly_order, baseline_wavelength)
