...
if __name__ == "__main__":
    if len(sys.argv)!=3:
        sys.exit("Wrong number of arguments given. Correct syntax: paths_intersection_v3.py path1 path2")
    else:
        path1 = sys.argv[1]
        path2 = sys.argv[2]

#input (info about protein chains and numbers of starting/ending amino acids):
#path1 = "./0/fit_paths/A_L185-A_H91.out.out"
#path2 = "./1/fit_paths/B_D265-A_H91.out.out"
chains_list = ["A", "B"]
...
out = path1.removesuffix(name1+'.out.out')+f"intsec_{name1}_{name2}.txt"
outfile = open(out, "w")
