    ...
    for file_name in os.listdir(folder_path):
        if file_name.endswith('.csv'):
            ...
            try:
                ...
                plt.plot(data["Wavelength (nm)"], data["Smoothed Intensity"], label=f"{file_name} (Smoothed)")
...
process_and_visualize_combined_with_smoothing(folder_path, smoothing_method="moving_average")
